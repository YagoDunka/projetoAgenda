...
<body class="bg-dark text-white">
	<div class="container">
		...
		<form action="recebeDadosLocal.jsp" method="POST">
			...
			<div class="row mb-3">
				<div class="col">
					<label class="form-label" for="cep">Informe cep</label> 
					<input class="form-control" maxlength="9" type="text" id="cep" name="cep" placeholder="Informe o cep (88000-000)" onblur="verEndereco()">
				</div>
				<div class="col">
					<label class="form-label" for="rua">Informe o Nome do Local</label>
					<input class="form-control me-2" type="text" id="nome" name="nome" placeholder="Nome do local">
				</div>
			</div>
			<div class="row mb-3">
				<div class="col">
					<label for="rua">Informe a rua</label> <input
						class="form-control me-2" type="text" id="rua" name="rua"
