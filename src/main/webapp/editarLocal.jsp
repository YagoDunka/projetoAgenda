	...
	<div class="container">
		...
		<form action="recebeDadosEditarLocal.jsp" method="POST">
			...
			<div class="row mb-3">
				...
				<div class="col">
					<label class="form-label" for="cep">Informe cep</label> <input
						class="form-control" maxlength="9" type="text" id="cep" name="cep"
						value=<%out.print(local.getCep());%> onblur="verEndereco()">
				</div>
				<div class="col">
					<label class="form-label" for="rua">Informe o Nome do Local</label>
					<input class="form-control me-2" type="text" id="nome" name="nome"
			...
			<div class="mt-5 d-flex justify-content-around">
				<button onchange="verEndereco()" class="btn btn-outline-secondary">Ver endereço</button>
